...
export const helpGuides: Record<Role, HelpGuide> = {
  ...
  MANAGER: {
    ...
    steps: [
      { icon: "1", title: "Add Team Member", text: "Add your A2 member from Network.", route: "network", action: "Open Network" },
      { icon: "2", title: "Help Your Team", text: "Help partners add customer members.", route: "tree", action: "Open Structure" },
      ...
      { icon: "7", title: "Unlock Beta Manager", text: "After 216 confirmed customers, A3 can be added.", route: "network", action: "Open Network" },
    ...
    nextActions: [
      { icon: "1", title: "Add your team member", text: "Open Network and create your next member.", route: "network", action: "Open Network" },
      { icon: "2", title: "Check 216 customer progress", text: "Open Home to see A3 progress.", route: "dashboard", action: "Open Home" },
  ...
  BETA_MANAGER: {
    ...
    steps: [
      ...
      { icon: "4", title: "Partner Commission", text: "A1 gets customer commission after confirmation.", route: "commissions", action: "Open Earnings" },
      { icon: "5", title: "Held Amount", text: "A3 amount is held until target is complete.", route: "commissions", action: "Open Earnings" },
  ...
  LEVEL_1: {
    ...
    steps: [
      { icon: "1", title: "Add Team Member", text: "Add A1 member from Network.", route: "network", action: "Open Network" },
      { icon: "2", title: "Check Network", text: "See your A1 members and customers.", route: "tree", action: "Open Structure" },
      ...
      { icon: "5", title: "Help Team Member", text: "Help A1 members add customers correctly.", route: "network", action: "Open Network" }
    ],
    nextActions: [
      { icon: "1", title: "Add A1 member", text: "Open Network and create A1.", route: "network", action: "Open Network" },
...
export function buildFirstTimeGuideSteps(role: Role): AppGuideStep[] {
  ...
  const roleSteps: Record<Role, AppGuideStep[]> = {
    ...
    MANAGER: [
      { icon: "M", title: "A3 Work", text: "Add A2 members and track your network." },
      { icon: "216", title: "216 Customers", text: "Track confirmed customers to unlock A3." },
    ...
    LEVEL_1: [
      { icon: "L1", title: "A2 Work", text: "Add A1 members and check your network." },
      { icon: "E", title: "Earnings", text: "Check commission after payment confirmation." }
    ],
    LEVEL_2: [
      { icon: "L2", title: "A1 Work", text: "Add customers and help them choose products." },
...
export function createRoleOptions(role: Role): Role[] {
  ...
  if (role === "MANAGER") return ["LEVEL_1", "BETA_MANAGER", "CUSTOMER"];
  if (role === "BETA_MANAGER") return ["LEVEL_1", "CUSTOMER"];
  if (role === "LEVEL_1") return ["LEVEL_2", "CUSTOMER"];
...
export function getSponsorOptions(role: Role, users: User[]) {
  ...
  if (role === "CUSTOMER") {
    return users.filter((user) => user.role === "LEVEL_2" || user.role === "LEVEL_1" || user.role === "MANAGER" || user.role === "BETA_MANAGER");
  }
  return [];
}
