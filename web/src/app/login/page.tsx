  ...
  return (
    <div className="flex-grow bg-slate-50 px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.35em] text-brand-600">Partner Access</p>
        <h1 className="mb-4 text-3xl font-bold text-slate-900">Login is available inside the Android app</h1>
        <p className="mx-auto mb-8 max-w-xl text-slate-600">
          Kerala Ayurvedh partner, customer, order, payment, and admin workflows are handled in the mobile app.
          Download the app and sign in with the phone number and password issued by Company Admin.
        </p>
        <Link
          href="/#download-app"
